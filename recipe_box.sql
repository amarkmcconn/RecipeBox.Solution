...
CREATE TABLE `recipetag` (
  ...
  KEY `IX_RecipeTag_RecipeId` (`RecipeId`),
  CONSTRAINT `FK_RecipeTag_Recipes_RecipeId` FOREIGN KEY (`RecipeId`) REFERENCES `recipes` (`RecipeId`) ON DELETE CASCADE,
  CONSTRAINT `FK_RecipeTag_Tags_TagId` FOREIGN KEY (`TagId`) REFERENCES `tags` (`TagId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tags` (
  ...
  CONSTRAINT `FK_Tags_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`) ON DELETE RESTRICT
...
-- Dump completed on 2022-06-02 10:56:37
